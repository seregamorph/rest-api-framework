...
public class AcceptStringCollectionValidatorTest extends AbstractUnitTest {
    ...
    @Spy
    private AcceptStringCollectionValidator validator;
    ...
    public void isValidShouldReturnFalseWithCustomMessage() {
        ...
        boolean result = validator.isValid(Collections.singletonList(SAMPLE_STRING_3), context);
    ...
    @Test
    public void isValidShouldReturnTrueWhenValidCollection() {
        when(annotation.value()).thenReturn(new String[] {SAMPLE_STRING, SAMPLE_STRING_2});

        validator.initialize(annotation);
        boolean result = validator.isValid(Collections.singletonList(SAMPLE_STRING), context);

        collector.checkThat(result, is(true));
    }

    @Test
    public void isValidShouldReturnTrueForNullCollection() {
