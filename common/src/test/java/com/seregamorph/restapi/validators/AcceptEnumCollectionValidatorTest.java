...
public class AcceptEnumCollectionValidatorTest extends AbstractUnitTest {
    ...
    @Spy
    private AcceptEnumCollectionValidator validator;
    ...
    public void isValidShouldReturnFalseWithCustomMessage() {
        ...
        boolean result = validator.isValid(Collections.singletonList(TestEnum.THIRD), context);
    ...
    public void isValidShouldReturnTrueWhenValidCollection() {
        ...
        validator.initialize(annotation);
        boolean result = validator.isValid(Collections.singletonList(TestEnum.FIRST), context);
